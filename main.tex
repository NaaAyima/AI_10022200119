...
\begin{figure}[H]
    \centering
    % [Insert screenshot of retrieved chunks and similarity scores]
...
\section{Deployment}
GovLens is publicly manifested as an interactive frontend using the \texttt{streamlit} framework and deployed seamlessly on Render. The UI \texttt{app.py} relies on heavily custom CSS, injecting specific branding (GovLens AI blue and gold layout), custom favicons, and click-to-fill interactive test queries. 
...
\begin{figure}[H]
    \centering
    % [Insert screenshot of logs/output]
